...
namespace HotelProject.Service.Helpers.Images
{
    public class ImageHelper:IImageHelper
    {
        ...
        private const string userImagesFolder = "article-users";
        ...
        public async Task<ImageUploadedDTO> Upload(string name, IFormFile imageFile, ImageType imageType, string folderName = null)
        {
            ...
            string message = imageType == ImageType.User ?
                $"{newFileName} adllı istifadəçi şəkli uğurla yüklənmişdir" :
                $"{newFileName} adlı məqalə şəkli uğula yüklənmişdir";
